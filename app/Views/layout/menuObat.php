...
<div class="content-wrapper">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-2">
                <button type="button" class="btn btn-block btn-primary mb-2 btnKategoriObat" id="btnKategoriObat">Kategori Obat</button>
            </div>
            <div class="col-lg-2">
                <button type="button" class="btn btn-block btn-primary mb-2 btnTipeObat" id="btnTipeObat">Tipe Obat</button>
            </div>
        </div>
    </div>