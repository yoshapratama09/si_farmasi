            ...
            <div class="bg-form">
                <form action="/tambahObat" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select id="select">
                                <option class="form-select <?= ($validation->hasError('namaSupplier')) ? 'is-invalid' : ''; ?>" id="namaSupplier" name="namaSupplier">Supplier</option>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select id="select">
                                <option class="form-select <?= ($validation->hasError('satuan1')) ? 'is-invalid' : ''; ?>" id="satuan1" name="satuan1" value="<?= old('satuan1'); ?>">Satuan</option>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10 option">
                            <select id="select">
                                <option class="form-select <?= ($validation->hasError('tipeObat')) ? 'is-invalid' : ''; ?>" id="tipeObat" name="tipeObat" value="<?= old('satuan1'); ?>">Tipe</option>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select id="select">
                                <option class="form-select <?= ($validation->hasError('kategoriObat')) ? 'is-invalid' : ''; ?>" id="kategoriObat" name="kategoriObat" value="<?= old('kategoriObat'); ?>">Kategori</option>
